...
type dqlCall struct {
	...
	DisableStreamingAggregation bool     `json:"disable_streaming_aggregation"`
...
func (m *mockDQL) Query(pos token.LnColPos, q, qTyp string, limit, offset, slimit int64, timeRange []any, alignTime, disableSampling, disableStreamingAggregation bool, uuids ...string) (map[string]any, error) {
	m.calls = append(m.calls, dqlCall{
		...
		DisableStreamingAggregation: disableStreamingAggregation,
...
func (r *recordingDQL) Query(pos token.LnColPos, q, qTyp string, limit, offset, slimit int64, timeRange []any, alignTime, disableSampling, disableStreamingAggregation bool, uuids ...string) (map[string]any, error) {
	...
	return r.inner.Query(pos, q, qTyp, limit, offset, slimit, timeRange, alignTime, disableSampling, disableStreamingAggregation, uuids...)
}
