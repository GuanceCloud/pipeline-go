...
函数原型： `fn dql(query: str, qtype: str = "dql", limit: int = 10000, offset: int = 0, slimit: int = 0, time_range: list = [], workspace_uuid: str = "", align_time: bool = true, disable_sampling: bool = true, disable_streaming_aggregation: bool = false) -> map`
